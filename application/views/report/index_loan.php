<div class="row">
	<div class="col-md-6">
		<div class="box box-success">
		    ...
		    <div class="box-body">
		    	<?php echo form_open('report/export_loan_members',array('id'=>'form_by_member','target'=>'_blank','onSubmit'=>'return validate(this)','autocomplete'=>'off')); ?>
	...
	<div class="col-md-6">
		<div class="box box-success">
		    ...
		    <div class="box-body">
				<?php echo form_open('report/export_loan_date',array('id'=>'form_deposit','target'=>'_blank','onSubmit'=>'return validate2(this)','autocomplete'=>'off')); ?>
	        	<div class="form-group">
...
<script type="text/javascript">
	...
	function show_report_members() {
		$('h3#output_title').text('DATA PINJAMAN');
	...
	function show_report() {
		$('h3#output_title2').text('DATA PINJAMAN');
	...
	var dataTable=$('#table-data').DataTable({
		...
		"searching": false,
      	...
      	"info":false,
      	"ajax": {
			"url": "<?php echo site_url('report/json_loan_members'); ?>",
			"type": "POST",
			"data":function(data) {
	      ...
	      $(api.column(5).footer()).html('Rp. '+rupiah(jml_angs));
	      $(api.column(6).footer()).html('Rp. '+rupiah(total_pinjaman));
	   },
      	"columnDefs": [
	...
	var dataTables=$('#table-data2').DataTable({
		...
		"searching": false,
      	...
      	"info":false,
      	"ajax": {
			"url": "<?php echo site_url('report/json_loan_date'); ?>",
			"type": "POST",
			"data":function(data) {
