...
class Loan_out extends CI_Controller {
	...
	public function index()
	{
		if (!$this->ion_auth->logged_in()){
			...
			$this->data['title']='DATA PINJAMAN BANK';
			$this->data['members'] = $this->deposit_m->get_member()->result();
			$this->data['loan']=$this->loan_m->get_all_external()->result();
			...
			$this->backend->display('loan/index_external',$this->data);
		}else{
	...
	public function save()
	{
        ...
        if(empty($this->input->post('bunga')))
        	$errors['bunga']='Bunga Harus Diisi.';
...
/* End of file Loan_out.php */
/* Location: ./application/controllers/Loan_out.php */